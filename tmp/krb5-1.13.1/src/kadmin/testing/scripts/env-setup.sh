...
TOP=/home/john/FSU_project/github/aligner/tmp/krb5-1.13.1/src/kadmin
STOP=/home/john/FSU_project/github/aligner/tmp/krb5-1.13.1/src/./kadmin
export TOP
export STOP
...
TOPLIBD=/home/john/FSU_project/github/aligner/tmp/krb5-1.13.1/src/lib
PROG_LIBPATH=-L/home/john/FSU_project/github/aligner/tmp/krb5-1.13.1/src/lib
BUILDTOP=/home/john/FSU_project/github/aligner/tmp/krb5-1.13.1/src
# XXX kludge!
PROG_RPATH=/home/john/FSU_project/github/aligner/tmp/krb5-1.13.1/src/lib
# This converts $(TOPLIBD) to $TOPLIBD
cat > /tmp/env_setup$$ <<\EOF
LD_LIBRARY_PATH=`echo $(PROG_LIBPATH) | sed -e "s/-L//g" -e "s/ /:/g"`; export LD_LIBRARY_PATH; 
EOF

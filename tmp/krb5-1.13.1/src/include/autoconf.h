...
/* Define if crypto implementation is NSS */
/* #undef CRYPTO_IMPL_NSS */
...
/* Define to 1 if you have the <python2.5/Python.h> header file. */
/* #undef HAVE_PYTHON2_5_PYTHON_H */
...
#define PACKAGE_STRING "Kerberos 5 1.13.1"
